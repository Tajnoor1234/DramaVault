        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?php echo e(route('dramas.index')); ?>" class="text-muted text-decoration-none">Dramas</a></li>
                    <li><a href="<?php echo e(route('casts.index')); ?>" class="text-muted text-decoration-none">Cast</a></li>
                    <li><a href="<?php echo e(route('news.index')); ?>" class="text-muted text-decoration-none">News</a></li>
...
</footer><?php /**PATH E:\XAMPP\htdocs\DramaVault\resources\views/partials/footer.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Import Dramas - Admin'); ?>
...
$(document).ready(function() {
    ...
    $('#searchBtn').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.import.search")); ?>',
            method: 'GET',
            data: { query, source },
    ...
    $(document).on('click', '.import-btn', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.import.store")); ?>',
            method: 'POST',
            data: {
                imdb_id: imdbId,
    ...
    $('#importTrendingBtn').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.import.trending")); ?>',
            method: 'POST',
            data: {
                type: type,
                limit: limit,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\XAMPP\htdocs\DramaVault\resources\views/admin/import/index.blade.php ENDPATH**/ ?>
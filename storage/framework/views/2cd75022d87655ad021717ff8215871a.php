        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('admin.dramas.update', $drama->slug)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="title" name="title" value="<?php echo e(old('title', $drama->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      id="synopsis" name="synopsis" rows="5" required><?php echo e(old('synopsis', $drama->synopsis)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                    ...
                                    <option value="drama" <?php echo e(old('type', $drama->type) == 'drama' ? 'selected' : ''); ?>>Drama</option>
                                    <option value="movie" <?php echo e(old('type', $drama->type) == 'movie' ? 'selected' : ''); ?>>Movie</option>
                                    <option value="series" <?php echo e(old('type', $drama->type) == 'series' ? 'selected' : ''); ?>>Series</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="episodes" name="episodes" value="<?php echo e(old('episodes', $drama->episodes)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="duration" name="duration" value="<?php echo e(old('duration', $drama->duration)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="country" name="country" value="<?php echo e(old('country', $drama->country)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="release_year" name="release_year" value="<?php echo e(old('release_year', $drama->release_year)); ?>" 
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                    ...
                                    <option value="upcoming" <?php echo e(old('status', $drama->status) == 'upcoming' ? 'selected' : ''); ?>>Upcoming</option>
                                    <option value="ongoing" <?php echo e(old('status', $drama->status) == 'ongoing' ? 'selected' : ''); ?>>Ongoing</option>
                                    <option value="completed" <?php echo e(old('status', $drama->status) == 'completed' ? 'selected' : ''); ?>>Completed</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="airing_date" name="airing_date" value="<?php echo e(old('airing_date', $drama->airing_date ? $drama->airing_date->format('Y-m-d') : '')); ?>">
                                    ...
                                    <div class="col-md-4 col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="genres[]" 
                                                   ...
                                                   <?php echo e(in_array($genre->id, old('genres', $drama->genres->pluck('id')->toArray())) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="castMembers">
                                <?php $__empty_1 = true; $__currentLoopData = $drama->cast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $castMember): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="row mb-2 cast-row">
                                        <div class="col-md-5">
                                            <select class="form-select" name="cast_id[]" required>
                                                ...
                                                <?php $__currentLoopData = $casts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($cast->id); ?>" <?php echo e($castMember->id == $cast->id ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="character_name[]" 
                                                   placeholder="Character Name" value="<?php echo e($castMember->pivot->character_name); ?>" required>
                                        </div>
                                        <div class="col-md-2">
                                            <select class="form-select" name="role_type[]" required>
                                                <option value="main" <?php echo e($castMember->pivot->role_type == 'main' ? 'selected' : ''); ?>>Main</option>
                                                <option value="supporting" <?php echo e($castMember->pivot->role_type == 'supporting' ? 'selected' : ''); ?>>Supporting</option>
                                                <option value="guest" <?php echo e($castMember->pivot->role_type == 'guest' ? 'selected' : ''); ?>>Guest</option>
                                            </select>
                                        </div>
                                        <div class="col-md-1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Current Poster -->
                        <?php if($drama->poster_path): ?>
                            <div class="mb-3">
                                <label class="form-label">Current Poster</label>
                                <div>
                                    <img src="<?php echo e($drama->poster_url); ?>" alt="Poster" style="max-height: 200px;">
                                </div>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Current Banner -->
                        <?php if($drama->banner_path): ?>
                            <div class="mb-3">
                                <label class="form-label">Current Banner</label>
                                <div>
                                    <img src="<?php echo e($drama->banner_url); ?>" alt="Banner" style="max-width: 100%; max-height: 150px;">
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\XAMPP\htdocs\DramaVault\resources\views/admin/dramas/edit.blade.php ENDPATH**/ ?>
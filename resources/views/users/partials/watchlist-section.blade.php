...
<div class="row g-3">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="watchlist-card card h-100 border-0 shadow-sm">
            <div class="row g-0 h-100">
                <div class="col-4">
                    <img src="{{ $drama->getPosterUrl() }}" 
                ...
                <div class="col-8">
                    <div class="card-body d-flex flex-column h-100">
                        ...
                        <div class="rating mb-2">
                            ...
                            <span class="text-muted small">({{ $drama->rating_count }})</span>
                        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <form action="{{ route('watchlist.store', $drama) }}" method="POST">
                                                @csrf
                                        ...
                                        <li>
                                            <form action="{{ route('watchlist.destroy', $drama) }}" method="POST"
...
<div class="text-center py-5">
    ...
    <a href="{{ route('dramas.index') }}" class="btn btn-primary mt-3">
        <i class="fas fa-explore me-1"></i>Explore Dramas
    </a>
</div>
@endif